...
const contactsController = require('../controllers/contactsController'); // Importing the contacts controller to handle the logic for each route
...
// Created a new POST route to create a new contact 
...
router.delete('/:id', contactsController.deleteContact); // This route will handle DELETE requests to the /:id path and will call the deleteContact method in the contactsController to delete a specific contact by their ID.

module.exports = router; // Exporting the router to be used in the main application file (app.js)